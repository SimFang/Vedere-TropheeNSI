    ...
    try {
      switch (editingSection) {
        ...
        case 'state':
          ...
          break;
        case 'description':
          await modifyPhotographerDescription(photographerState.isPhotographer, newValue);
          setUser((prevUser) => ({ ...prevUser, description: newValue })); // Update description in user state
          break;
        default:
          break;
      }
        ...
        <View style={styles.top}>
          <View style={styles.left}>
            ...
            <View
              ...
              onTouchEnd={() => handleEdit('description', user?.description)} // Handle click on bio
            >
              <Text style={styles.bio}>{user?.description || 'No bio available'}</Text>
              <Ionicons name="pencil-sharp" size={15}></Ionicons>
            </View>
          </View>
          <View style={styles.right}>
            <ProfilePicture
              ...
              modificationId={photographerState.isPhotographer}
              onUpload={onUpload}
            />
          </View>
        </View>
